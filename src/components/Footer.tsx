...
<path d="M68.8089 25H62.0409V0.879999H68.8089V25ZM77.7386 5.2H70.9706V0.879999H77.7386V5.2ZM77.7386 25H70.9706V6.856H77.7386V25ZM86.6683 25H79.9003V6.856H86.2363V12.364H86.5963C86.9923 9.34 88.9723 6.496 93.8323 6.496C98.7283 6.496 101.032 9.448 101.032 13.372V25H94.2643V15.856C94.2643 13.336 93.3283 12.544 90.3763 12.544C87.3883 12.544 86.6683 13.3 86.6683 15.64V25ZM109.801 25H103.033V0.879999H109.801V13.156H113.005L117.001 6.856H124.993L118.549 15.676L124.885 25H116.893L113.077 19.204H109.801V25ZM135.825 25.36C129.669 25.36 125.349 22.732 125.349 15.928C125.349 10.024 129.633 6.496 135.681 6.496C141.945 6.496 145.941 9.628 145.941 15.46C145.941 16.072 145.905 16.54 145.833 17.188H131.613C131.721 19.384 132.693 19.996 135.573 19.996C138.309 19.996 139.029 19.528 139.029 18.448V18.052H145.797V18.484C145.797 22.516 141.945 25.36 135.825 25.36ZM135.537 11.68C133.053 11.68 132.009 12.22 131.721 13.768H139.389C139.137 12.22 138.057 11.68 135.537 11.68ZM155.996 25.36C150.452 25.36 147.392 21.796 147.392 15.928C147.392 10.024 150.38 6.496 155.708 6.496C159.992 6.496 162.008 8.512 162.548 11.536H162.908V0.879999H169.676V25H163.34V20.104H162.98C162.404 23.704 160.244 25.36 155.996 25.36ZM154.232 15.928C154.232 18.34 155.312 19.168 158.444 19.168C161.468 19.168 162.908 18.592 162.908 15.964V15.712C162.908 13.156 161.468 12.652 158.444 12.652C155.312 12.652 154.232 13.516 154.232 15.928Z" fill="#D434FE"/>
                 ...
                 <p className='mt-4 text-white text-[12px]'>Getlinked Tech Hackathon is a technology
...
of technology</p>
<div className="inline-flex mt-4 lg:mt-8 text-white text-xs font-normal font-['Montserrat'] leading-tight">Terms of Use  <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-4 text-purple-600">
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 17.25L12 21m0 0l-3.75-3.75M12 21V3" />
</svg>
</span>     Privacy Policy</div>
        </div>
  
        <div className="col-span-1 lg:ml-24">
        <div className="UsefulLinks text-fuchsia-500 text-sm font-semibold font-['Montserrat'] leading-normal">Useful Links</div>
  
          <div className="mt-3 grid space-y-3">
           
            <div className="Overview text-white text-xs font-normal font-['Montserrat'] leading-tight">Overview</div>     
         
            <div className="Overview text-white text-xs font-normal font-['Montserrat'] leading-tight">Timeline</div>           
         
            <div className="Overview text-white text-xs font-normal font-['Montserrat'] leading-tight">FAQs</div>               
        
            <div className="Overview text-white text-xs font-normal font-['Montserrat'] leading-tight">Register</div>             
          </div>
        </div>
  
        <div className="col-span-1">
        <div className="ContactUs text-fuchsia-500 text-sm font-semibold font-['Montserrat'] leading-normal">Contact Us</div>  
          <div className="mt-3 grid space-y-3">
          <div className="inline-flex text-white text-xs font-normal font-['Montserrat']"><svg className='mr-2' width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
+234 6707653444</div>
                <div className="inline-flex text-white text-xs font-normal font-['Montserrat'] leading-tight"><svg className='mr-2' width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
27,Alara Street<br/>Yaba 100012<br/>Lagos State</div>
          </div>
        </div>
      ...
      <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
        <div className="flex justify-between items-center">
          <p className="text-sm text-gray-400">All rights reserved. © getlinked Ltd.</p>
        </div>
        <div>
        <div className="whitespace-nowrap text-fuchsia-500 text-xs font-normal font-['Montserrat']">Follow us</div>
